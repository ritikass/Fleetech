...
import com.example.fleetech.activities.AdminActivity
import com.example.fleetech.retrofit.response.UpdateData
import com.example.fleetech.retrofit.response.VerifyData

class AdminAdapterLogin(private val mList: ArrayList<VerifyData>, val adminInterFace: AdminActivity) : RecyclerView.Adapter<AdminAdapterLogin.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.vehicleNo.text = UpdateDataList.MobileNo
